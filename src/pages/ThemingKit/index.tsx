import './css/mytheme.min.css';

export default function ThemingKitPage() {
	return (
		<>
			...
			<div className='container-fluid'>
				<div className='row mt-3'>
					<div className='col-lg-3 col-md-6'>
						<p>
							Hello. I'm a little bit of body text. Plain and
							simple.
						</p>
					...
					<div className='col-lg-3 col-md-6'>
						<div
							className='mb-2 alert alert-primary'
							role='alert'>
						...
						<div
							className='mb-2 alert alert-secondary'
							role='alert'>
						...
						<div
							className='mb-2 alert alert-danger'
							role='alert'>
						...
						<div
							className='mb-2 alert alert-warning'
							role='alert'>
						...
						<div
							className='mb-2 alert alert-light'
							role='alert'>
						...
						<div
							className='mb-2 alert alert-dark'
							role='alert'>
